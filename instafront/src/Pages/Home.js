       ...
       {/* <Button onClick={handleUserInfo}> Get user Info</Button> */}
          ...
          <div className="text-center mt-4">
            <Card style={{ width: "28rem" }} className="card col-6 offset-3">
              ...
              <Card.Body> 
                <Card.Title><h1 className="text-primary">Profile</h1></Card.Title>
                <Card.Text>
                 <h3 className="text-secondary">Welcome {data.name}</h3>
                </Card.Text>
              </Card.Body>
              <ListGroup className="list-group-flush">
                <ListGroup.Item><h5>Username : {data.userName}</h5></ListGroup.Item>
                <ListGroup.Item><h5>Email : {data.email}</h5></ListGroup.Item>
